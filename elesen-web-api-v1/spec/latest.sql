...
CREATE TABLE `lpi_engines` (
  `id` CHAR(36) NOT NULL,
  `full_inspection_lpi_id` CHAR(36) DEFAULT NULL,
  `engine_number` INT DEFAULT NULL,
  ...
  `fuel_type_code_id` VARCHAR(50) DEFAULT NULL,
  `condition_code_id` VARCHAR(50) DEFAULT NULL,
  `is_main_engine` TINYINT(1) DEFAULT 0,
  `is_functional` TINYINT(1) DEFAULT 1,
  `is_compliant` TINYINT(1) DEFAULT 1,
  `engine_overall_picture_path` VARCHAR(255) DEFAULT NULL,
  `engine_plate_picture_path` VARCHAR(255) DEFAULT NULL,
  ...
  `lpi_inspection_id` CHAR(36) DEFAULT NULL,
  ...
  `has_pev` TINYINT(1) DEFAULT NULL,
  `pev_no` VARCHAR(255) DEFAULT NULL,
  `engine_picture_path` VARCHAR(255) DEFAULT NULL,
  `engine_no_picture_path` VARCHAR(255) DEFAULT NULL,
  `pev_no_picture_path` VARCHAR(255) DEFAULT NULL,
  `turbo_picture_path` VARCHAR(255) DEFAULT NULL,
  `generator_picture_path` VARCHAR(255) DEFAULT NULL,
  `engine_brand_additional` VARCHAR(255) DEFAULT NULL,
  `engine_model_additional` VARCHAR(255) DEFAULT NULL,
  `engine_has_turbo_additional` TINYINT(1) DEFAULT NULL,
  `turbo_hp_additional` INT DEFAULT NULL,
  `engine_no_additional` VARCHAR(255) DEFAULT NULL,
  `has_pev_additional` TINYINT(1) DEFAULT NULL,
  `pev_no_additional` VARCHAR(255) DEFAULT NULL,
  `engine_picture_path_additional` VARCHAR(255) DEFAULT NULL,
  `engine_no_picture_path_additional` VARCHAR(255) DEFAULT NULL,
  `pev_no_picture_path_additional` VARCHAR(255) DEFAULT NULL,
  `turbo_picture_path_additional` VARCHAR(255) DEFAULT NULL,
  `has_generator` TINYINT(1) DEFAULT NULL,
  `generator_brand` VARCHAR(255) DEFAULT NULL,
  `generator_model` VARCHAR(255) DEFAULT NULL,
  `generator_has_turbo` TINYINT(1) DEFAULT NULL,
  `generator_wattage` INT DEFAULT NULL,
  `generator_no` VARCHAR(255) DEFAULT NULL,
  `generator_has_pev` TINYINT(1) DEFAULT NULL,
  `generator_pev_no` VARCHAR(255) DEFAULT NULL,
  `generator_brand_additional` VARCHAR(255) DEFAULT NULL,
  `generator_model_additional` VARCHAR(255) DEFAULT NULL,
  `generator_has_turbo_additional` TINYINT(1) DEFAULT NULL,
  `generator_wattage_additional` INT DEFAULT NULL,
  `generator_no_additional` VARCHAR(255) DEFAULT NULL,
  `generator_has_pev_additional` TINYINT(1) DEFAULT NULL,
  `generator_pev_no_additional` VARCHAR(255) DEFAULT NULL,
  `generator_picture_path_additional` VARCHAR(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
