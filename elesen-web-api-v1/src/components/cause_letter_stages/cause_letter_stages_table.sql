-- CauseLetterStages Table Definition
CREATE TABLE `cause_letter_stages` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_cause_letter_stages_application_id` (`application_id`),
  CONSTRAINT `fk_cause_letter_stages_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
