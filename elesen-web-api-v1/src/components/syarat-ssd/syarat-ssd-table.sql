...
CREATE TABLE `syarat_ssd` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_syarat_ssd_application_id` (`application_id`),
  CONSTRAINT `fk_syarat_ssd_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
