...
CREATE TABLE `modules2` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_modules2_application_id` (`application_id`),
  CONSTRAINT `fk_modules2_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
