-- Ppv04bPrintLicenseGrant Table Definition
CREATE TABLE `ppv04b_print_license_grant` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_ppv04b_print_license_grant_application_id` (`application_id`),
  CONSTRAINT `fk_ppv04b_print_license_grant_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
