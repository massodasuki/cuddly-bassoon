-- CourseParticipants Table Definition
CREATE TABLE `course_participants` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_course_participants_application_id` (`application_id`),
  CONSTRAINT `fk_course_participants_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
