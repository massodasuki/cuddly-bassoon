...
CREATE TABLE `procurements` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_procurements_application_id` (`application_id`),
  CONSTRAINT `fk_procurements_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
