-- PantasBatches Table Definition
CREATE TABLE `pantas_batches` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_pantas_batches_application_id` (`application_id`),
  CONSTRAINT `fk_pantas_batches_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
