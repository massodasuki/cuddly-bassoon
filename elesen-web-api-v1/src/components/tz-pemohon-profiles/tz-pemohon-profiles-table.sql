-- TzPemohonProfiles Table Definition
CREATE TABLE `tz_pemohon_profiles` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_tz_pemohon_profiles_application_id` (`application_id`),
  CONSTRAINT `fk_tz_pemohon_profiles_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
