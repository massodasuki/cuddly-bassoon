...
CREATE TABLE `lpi_vessels` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_lpi_vessels_application_id` (`application_id`),
  CONSTRAINT `fk_lpi_vessels_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
