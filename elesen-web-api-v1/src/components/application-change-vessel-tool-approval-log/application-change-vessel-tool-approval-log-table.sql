-- ApplicationChangeVesselToolApprovalLog Table Definition
CREATE TABLE `application_change_vessel_tool_approval_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_application_change_vessel_tool_approval_log_application_id` (`application_id`),
  CONSTRAINT `fk_application_change_vessel_tool_approval_log_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
