...
CREATE TABLE `ppv04bs` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_ppv04bs_application_id` (`application_id`),
  CONSTRAINT `fk_ppv04bs_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
