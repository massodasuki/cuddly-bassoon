-- Ppv35VesselPaymentItems Table Definition
CREATE TABLE `ppv35_vessel_payment_items` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_ppv35_vessel_payment_items_application_id` (`application_id`),
  CONSTRAINT `fk_ppv35_vessel_payment_items_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
