...
CREATE TABLE `tz_vessels` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_tz_vessels_application_id` (`application_id`),
  CONSTRAINT `fk_tz_vessels_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
