-- VesselBankStatements Table Definition
CREATE TABLE `vessel_bank_statements` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_vessel_bank_statements_application_id` (`application_id`),
  CONSTRAINT `fk_vessel_bank_statements_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
