...
import { CreateVesselBankStatementsDto } from './dto/create-vessel-bank-statements.dto';
import { UpdateVesselBankStatementsDto } from './dto/update-vessel-bank-statements.dto';
