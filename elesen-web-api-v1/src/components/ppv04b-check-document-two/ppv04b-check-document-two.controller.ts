...
import { CreatePpv04bCheckDocumentTwoDto } from './dto/create-ppv04b-check-document-two.dto';
import { UpdatePpv04bCheckDocumentTwoDto } from './dto/update-ppv04b-check-document-two.dto';
