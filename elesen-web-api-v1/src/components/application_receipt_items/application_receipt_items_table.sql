-- ApplicationReceiptItems Table Definition
CREATE TABLE `application_receipt_items` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_application_receipt_items_application_id` (`application_id`),
  CONSTRAINT `fk_application_receipt_items_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
