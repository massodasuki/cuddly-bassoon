...
CREATE TABLE `user_role2` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_user_role2_application_id` (`application_id`),
  CONSTRAINT `fk_user_role2_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
