-- ApplicationTasks Table Definition
CREATE TABLE `application_tasks` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_application_tasks_application_id` (`application_id`),
  CONSTRAINT `fk_application_tasks_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
