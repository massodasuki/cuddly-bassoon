-- Ppv04bAgreeVesselNumbers Table Definition
CREATE TABLE `ppv04b_agree_vessel_numbers` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_ppv04b_agree_vessel_numbers_application_id` (`application_id`),
  CONSTRAINT `fk_ppv04b_agree_vessel_numbers_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
