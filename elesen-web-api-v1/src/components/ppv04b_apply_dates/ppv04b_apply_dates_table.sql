-- Ppv04bApplyDates Table Definition
CREATE TABLE `ppv04b_apply_dates` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_ppv04b_apply_dates_application_id` (`application_id`),
  CONSTRAINT `fk_ppv04b_apply_dates_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
