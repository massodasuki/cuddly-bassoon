-- SlpDomestikApplications Table Definition
CREATE TABLE `slp_domestik_applications` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_slp_domestik_applications_application_id` (`application_id`),
  CONSTRAINT `fk_slp_domestik_applications_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
