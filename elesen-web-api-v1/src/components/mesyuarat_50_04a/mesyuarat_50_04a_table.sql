-- Mesyuarat5004a Table Definition
CREATE TABLE `mesyuarat_50_04a` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_mesyuarat_50_04a_application_id` (`application_id`),
  CONSTRAINT `fk_mesyuarat_50_04a_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
