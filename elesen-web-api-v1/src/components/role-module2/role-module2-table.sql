...
CREATE TABLE `role_module2` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_role_module2_application_id` (`application_id`),
  CONSTRAINT `fk_role_module2_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
