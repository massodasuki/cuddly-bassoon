-- Kpv03VesselLicenseApplicationBenificialOwners Table Definition
CREATE TABLE `kpv03_vessel_license_application_benificial_owners` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_kpv03_vessel_license_application_benificial_owners_application_id` (`application_id`),
  CONSTRAINT `fk_kpv03_vessel_license_application_benificial_owners_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
