-- MesyuaratKickoff04a Table Definition
CREATE TABLE `mesyuarat_kickoff_04a` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_mesyuarat_kickoff_04a_application_id` (`application_id`),
  CONSTRAINT `fk_mesyuarat_kickoff_04a_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
