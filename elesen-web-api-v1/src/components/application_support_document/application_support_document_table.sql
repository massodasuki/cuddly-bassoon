-- ApplicationSupportDocument Table Definition
CREATE TABLE `application_support_document` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_application_support_document_application_id` (`application_id`),
  CONSTRAINT `fk_application_support_document_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
