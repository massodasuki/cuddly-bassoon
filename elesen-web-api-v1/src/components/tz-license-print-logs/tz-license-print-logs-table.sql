-- TzLicensePrintLogs Table Definition
CREATE TABLE `tz_license_print_logs` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_tz_license_print_logs_application_id` (`application_id`),
  CONSTRAINT `fk_tz_license_print_logs_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
