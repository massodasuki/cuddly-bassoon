-- VesselLicenseShareholders Table Definition
CREATE TABLE `vessel_license_shareholders` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_vessel_license_shareholders_application_id` (`application_id`),
  CONSTRAINT `fk_vessel_license_shareholders_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
