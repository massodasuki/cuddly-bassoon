-- AppointmentsInspections Table Definition
CREATE TABLE `appointments_inspections` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_appointments_inspections_application_id` (`application_id`),
  CONSTRAINT `fk_appointments_inspections_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
