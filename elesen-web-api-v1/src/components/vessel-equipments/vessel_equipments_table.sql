-- VesselEquipments Table Definition
CREATE TABLE `vessel_equipments` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_vessel_equipments_application_id` (`application_id`),
  CONSTRAINT `fk_vessel_equipments_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
