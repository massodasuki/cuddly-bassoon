-- UserBankAccounts Table Definition
CREATE TABLE `user_bank_accounts` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_user_bank_accounts_application_id` (`application_id`),
  CONSTRAINT `fk_user_bank_accounts_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
