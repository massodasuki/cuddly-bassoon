-- BaseTransferLogs Table Definition
CREATE TABLE `base_transfer_logs` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_base_transfer_logs_application_id` (`application_id`),
  CONSTRAINT `fk_base_transfer_logs_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
