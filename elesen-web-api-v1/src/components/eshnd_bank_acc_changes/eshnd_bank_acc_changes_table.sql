-- EshndBankAccChanges Table Definition
CREATE TABLE `eshnd_bank_acc_changes` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_eshnd_bank_acc_changes_application_id` (`application_id`),
  CONSTRAINT `fk_eshnd_bank_acc_changes_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
