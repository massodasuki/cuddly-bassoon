-- SlpLuarNegaraBuktiVesel Table Definition
CREATE TABLE `slp_luar_negara_bukti_vesel` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_slp_luar_negara_bukti_vesel_application_id` (`application_id`),
  CONSTRAINT `fk_slp_luar_negara_bukti_vesel_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
