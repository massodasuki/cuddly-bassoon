-- DeviceRegistration Table Definition
CREATE TABLE `device_registration` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_device_registration_application_id` (`application_id`),
  CONSTRAINT `fk_device_registration_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
