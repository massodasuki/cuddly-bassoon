-- TzPermohonanInspections Table Definition
CREATE TABLE `tz_permohonan_inspections` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_tz_permohonan_inspections_application_id` (`application_id`),
  CONSTRAINT `fk_tz_permohonan_inspections_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
