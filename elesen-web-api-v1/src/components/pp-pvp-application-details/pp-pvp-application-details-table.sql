-- PpPvpApplicationDetails Table Definition
CREATE TABLE `pp_pvp_application_details` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_pp_pvp_application_details_application_id` (`application_id`),
  CONSTRAINT `fk_pp_pvp_application_details_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
