-- VesselRegistered Table Definition
CREATE TABLE `vessel_registered` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_vessel_registered_application_id` (`application_id`),
  CONSTRAINT `fk_vessel_registered_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
