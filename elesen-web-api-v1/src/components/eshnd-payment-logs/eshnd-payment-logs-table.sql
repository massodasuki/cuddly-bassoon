-- EshndPaymentLogs Table Definition
CREATE TABLE `eshnd_payment_logs` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_eshnd_payment_logs_application_id` (`application_id`),
  CONSTRAINT `fk_eshnd_payment_logs_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
