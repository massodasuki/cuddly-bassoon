-- FullInspectionLpis Table Definition
CREATE TABLE `full_inspection_lpis` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_full_inspection_lpis_application_id` (`application_id`),
  CONSTRAINT `fk_full_inspection_lpis_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
