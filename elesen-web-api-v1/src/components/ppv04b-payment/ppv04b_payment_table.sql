-- Ppv04bPayment Table Definition
CREATE TABLE `ppv04b_payment` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_ppv04b_payment_application_id` (`application_id`),
  CONSTRAINT `fk_ppv04b_payment_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
