-- Kpv03VesselLicenseApplicationInspectionItems Table Definition
CREATE TABLE `kpv03_vessel_license_application_inspection_items` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_kpv03_vessel_license_application_inspection_items_application_id` (`application_id`),
  CONSTRAINT `fk_kpv03_vessel_license_application_inspection_items_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
