-- LpiFishingGears Table Definition
CREATE TABLE `lpi_fishing_gears` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_lpi_fishing_gears_application_id` (`application_id`),
  CONSTRAINT `fk_lpi_fishing_gears_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
