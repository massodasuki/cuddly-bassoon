-- LpiInspectionItems Table Definition
CREATE TABLE `lpi_inspection_items` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_lpi_inspection_items_application_id` (`application_id`),
  CONSTRAINT `fk_lpi_inspection_items_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
