-- ElaunSaraHidupNds Table Definition
CREATE TABLE `elaun_sara_hidup_nds` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_elaun_sara_hidup_nds_application_id` (`application_id`),
  CONSTRAINT `fk_elaun_sara_hidup_nds_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
