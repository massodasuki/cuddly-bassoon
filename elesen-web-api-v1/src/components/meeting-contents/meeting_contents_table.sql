-- MeetingContents Table Definition
CREATE TABLE `meeting_contents` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_meeting_contents_application_id` (`application_id`),
  CONSTRAINT `fk_meeting_contents_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
