-- EshndBankChangeDocs Table Definition
CREATE TABLE `eshnd_bank_change_docs` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_eshnd_bank_change_docs_application_id` (`application_id`),
  CONSTRAINT `fk_eshnd_bank_change_docs_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
