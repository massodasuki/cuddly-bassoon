-- ApplicationAtfPayment Table Definition
CREATE TABLE `application_atf_payment` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_application_atf_payment_application_id` (`application_id`),
  CONSTRAINT `fk_application_atf_payment_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
