-- MppiVesselMinutePostponement Table Definition
CREATE TABLE `mppi_vessel_minute_postponement` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_mppi_vessel_minute_postponement_application_id` (`application_id`),
  CONSTRAINT `fk_mppi_vessel_minute_postponement_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
