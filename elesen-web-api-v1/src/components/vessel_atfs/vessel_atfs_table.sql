...
CREATE TABLE `vessel_atfs` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_vessel_atfs_application_id` (`application_id`),
  CONSTRAINT `fk_vessel_atfs_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
