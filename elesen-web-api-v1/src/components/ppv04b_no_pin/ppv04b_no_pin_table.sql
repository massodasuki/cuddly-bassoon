...
CREATE TABLE `ppv04b_no_pin` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_ppv04b_no_pin_application_id` (`application_id`),
  CONSTRAINT `fk_ppv04b_no_pin_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
