-- Ppv04bInspectionReportOne Table Definition
CREATE TABLE `ppv04b_inspection_report_one` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_ppv04b_inspection_report_one_application_id` (`application_id`),
  CONSTRAINT `fk_ppv04b_inspection_report_one_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
