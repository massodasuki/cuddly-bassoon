-- MeetingAttendees Table Definition
CREATE TABLE `meeting_attendees` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_meeting_attendees_application_id` (`application_id`),
  CONSTRAINT `fk_meeting_attendees_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
