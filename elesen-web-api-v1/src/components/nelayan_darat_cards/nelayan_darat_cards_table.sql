-- NelayanDaratCards Table Definition
CREATE TABLE `nelayan_darat_cards` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_nelayan_darat_cards_application_id` (`application_id`),
  CONSTRAINT `fk_nelayan_darat_cards_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
