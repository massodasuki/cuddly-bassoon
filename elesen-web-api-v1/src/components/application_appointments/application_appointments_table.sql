-- ApplicationAppointments Table Definition
CREATE TABLE `application_appointments` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_application_appointments_application_id` (`application_id`),
  CONSTRAINT `fk_application_appointments_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
