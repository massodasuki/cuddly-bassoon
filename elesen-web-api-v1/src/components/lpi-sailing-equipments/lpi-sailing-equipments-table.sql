-- LpiSailingEquipments Table Definition
CREATE TABLE `lpi_sailing_equipments` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_lpi_sailing_equipments_application_id` (`application_id`),
  CONSTRAINT `fk_lpi_sailing_equipments_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
