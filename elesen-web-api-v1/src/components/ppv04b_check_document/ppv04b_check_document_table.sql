-- Ppv04bCheckDocument Table Definition
CREATE TABLE `ppv04b_check_document` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_ppv04b_check_document_application_id` (`application_id`),
  CONSTRAINT `fk_ppv04b_check_document_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
