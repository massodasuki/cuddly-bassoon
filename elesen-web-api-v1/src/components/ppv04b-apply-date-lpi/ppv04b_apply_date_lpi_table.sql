-- Ppv04bApplyDateLpi Table Definition
CREATE TABLE `ppv04b_apply_date_lpi` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_ppv04b_apply_date_lpi_application_id` (`application_id`),
  CONSTRAINT `fk_ppv04b_apply_date_lpi_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
