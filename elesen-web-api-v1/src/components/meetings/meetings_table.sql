...
CREATE TABLE `meetings` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_meetings_application_id` (`application_id`),
  CONSTRAINT `fk_meetings_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
