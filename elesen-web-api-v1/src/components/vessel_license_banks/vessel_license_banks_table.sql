-- VesselLicenseBanks Table Definition
CREATE TABLE `vessel_license_banks` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_vessel_license_banks_application_id` (`application_id`),
  CONSTRAINT `fk_vessel_license_banks_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
