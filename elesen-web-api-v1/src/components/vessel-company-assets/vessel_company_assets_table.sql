-- VesselCompanyAssets Table Definition
CREATE TABLE `vessel_company_assets` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_vessel_company_assets_application_id` (`application_id`),
  CONSTRAINT `fk_vessel_company_assets_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
