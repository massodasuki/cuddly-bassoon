...
CREATE TABLE `cause_letters` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_cause_letters_application_id` (`application_id`),
  CONSTRAINT `fk_cause_letters_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
