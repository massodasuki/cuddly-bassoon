-- BaseTransferApps Table Definition
CREATE TABLE `base_transfer_apps` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_base_transfer_apps_application_id` (`application_id`),
  CONSTRAINT `fk_base_transfer_apps_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
