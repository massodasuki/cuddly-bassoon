-- MppiVesselPemantauan Table Definition
CREATE TABLE `mppi_vessel_pemantauan` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_mppi_vessel_pemantauan_application_id` (`application_id`),
  CONSTRAINT `fk_mppi_vessel_pemantauan_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
