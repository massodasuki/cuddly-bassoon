-- ApplicationLicensePrintLogs Table Definition
CREATE TABLE `application_license_print_logs` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_application_license_print_logs_application_id` (`application_id`),
  CONSTRAINT `fk_application_license_print_logs_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
