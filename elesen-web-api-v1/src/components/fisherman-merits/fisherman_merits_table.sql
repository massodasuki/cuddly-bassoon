-- FishermanMerits Table Definition
CREATE TABLE `fisherman_merits` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_fisherman_merits_application_id` (`application_id`),
  CONSTRAINT `fk_fisherman_merits_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
