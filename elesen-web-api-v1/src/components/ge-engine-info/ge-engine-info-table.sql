...
CREATE TABLE `ge_engine_info` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_ge_engine_info_application_id` (`application_id`),
  CONSTRAINT `fk_ge_engine_info_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
