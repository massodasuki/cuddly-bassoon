-- Ppv04bSupportingDocAttachments Table Definition
CREATE TABLE `ppv04b_supporting_doc_attachments` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_ppv04b_supporting_doc_attachments_application_id` (`application_id`),
  CONSTRAINT `fk_ppv04b_supporting_doc_attachments_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
