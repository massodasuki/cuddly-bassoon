-- LpiInlandFishingEquipmentItems Table Definition
CREATE TABLE `lpi_inland_fishing_equipment_items` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_lpi_inland_fishing_equipment_items_application_id` (`application_id`),
  CONSTRAINT `fk_lpi_inland_fishing_equipment_items_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
