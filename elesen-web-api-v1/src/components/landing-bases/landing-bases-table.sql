...
CREATE TABLE `landing_bases` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_landing_bases_application_id` (`application_id`),
  CONSTRAINT `fk_landing_bases_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
