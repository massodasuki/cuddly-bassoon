-- MppiVesselMinuteMessage Table Definition
CREATE TABLE `mppi_vessel_minute_message` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_mppi_vessel_minute_message_application_id` (`application_id`),
  CONSTRAINT `fk_mppi_vessel_minute_message_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
