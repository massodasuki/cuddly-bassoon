-- Ppv04aVesselMinutePostponement Table Definition
CREATE TABLE `ppv04a_vessel_minute_postponement` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_ppv04a_vessel_minute_postponement_application_id` (`application_id`),
  CONSTRAINT `fk_ppv04a_vessel_minute_postponement_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
