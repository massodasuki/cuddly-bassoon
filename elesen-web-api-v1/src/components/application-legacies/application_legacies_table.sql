-- ApplicationLegacies Table Definition
CREATE TABLE `application_legacies` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_application_legacies_application_id` (`application_id`),
  CONSTRAINT `fk_application_legacies_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
