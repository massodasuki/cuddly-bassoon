-- PpPt01Reviews Table Definition
CREATE TABLE `pp_pt_01_reviews` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_pp_pt_01_reviews_application_id` (`application_id`),
  CONSTRAINT `fk_pp_pt_01_reviews_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
