-- FishingEquipmentLpis Table Definition
CREATE TABLE `fishing_equipment_lpis` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_fishing_equipment_lpis_application_id` (`application_id`),
  CONSTRAINT `fk_fishing_equipment_lpis_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
