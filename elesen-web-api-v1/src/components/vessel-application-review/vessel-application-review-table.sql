-- VesselApplicationReview Table Definition
CREATE TABLE `vessel_application_review` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_vessel_application_review_application_id` (`application_id`),
  CONSTRAINT `fk_vessel_application_review_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
