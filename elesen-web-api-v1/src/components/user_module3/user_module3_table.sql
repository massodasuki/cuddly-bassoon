...
CREATE TABLE `user_module3` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_user_module3_application_id` (`application_id`),
  CONSTRAINT `fk_user_module3_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
