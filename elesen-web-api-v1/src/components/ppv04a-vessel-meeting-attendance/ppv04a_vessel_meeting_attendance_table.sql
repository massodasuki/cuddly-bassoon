-- Ppv04aVesselMeetingAttendance Table Definition
CREATE TABLE `ppv04a_vessel_meeting_attendance` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_ppv04a_vessel_meeting_attendance_application_id` (`application_id`),
  CONSTRAINT `fk_ppv04a_vessel_meeting_attendance_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
