-- RefCauseLetterWorkflows Table Definition
CREATE TABLE `ref_cause_letter_workflows` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_ref_cause_letter_workflows_application_id` (`application_id`),
  CONSTRAINT `fk_ref_cause_letter_workflows_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
