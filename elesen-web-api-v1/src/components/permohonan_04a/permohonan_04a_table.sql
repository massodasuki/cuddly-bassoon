-- Permohonan04a Table Definition
CREATE TABLE `permohonan_04a` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_permohonan_04a_application_id` (`application_id`),
  CONSTRAINT `fk_permohonan_04a_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
