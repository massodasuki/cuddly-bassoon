-- ApplicationTpuReceipts Table Definition
CREATE TABLE `application_tpu_receipts` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_application_tpu_receipts_application_id` (`application_id`),
  CONSTRAINT `fk_application_tpu_receipts_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
