-- TzPermohonanRayuans Table Definition
CREATE TABLE `tz_permohonan_rayuans` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_tz_permohonan_rayuans_application_id` (`application_id`),
  CONSTRAINT `fk_tz_permohonan_rayuans_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
