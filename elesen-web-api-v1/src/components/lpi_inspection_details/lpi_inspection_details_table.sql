-- LpiInspectionDetails Table Definition
CREATE TABLE `lpi_inspection_details` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_lpi_inspection_details_application_id` (`application_id`),
  CONSTRAINT `fk_lpi_inspection_details_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
