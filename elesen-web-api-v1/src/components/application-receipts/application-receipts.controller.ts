...
import { CreateApplicationReceiptsDto } from './dto/create-application-receipts.dto';
import { UpdateApplicationReceiptsDto } from './dto/update-application-receipts.dto';
