...
CREATE TABLE `lpi_engines` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_lpi_engines_application_id` (`application_id`),
  CONSTRAINT `fk_lpi_engines_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
