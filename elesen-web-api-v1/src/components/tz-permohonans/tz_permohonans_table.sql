-- TzPermohonans Table Definition
CREATE TABLE `tz_permohonans` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_tz_permohonans_application_id` (`application_id`),
  CONSTRAINT `fk_tz_permohonans_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
