-- Kpv03VesselLicenseApplicationInformation Table Definition
CREATE TABLE `kpv03_vessel_license_application_information` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_kpv03_vessel_license_application_information_application_id` (`application_id`),
  CONSTRAINT `fk_kpv03_vessel_license_application_information_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
