-- LpiInspections Table Definition
CREATE TABLE `lpi_inspections` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_lpi_inspections_application_id` (`application_id`),
  CONSTRAINT `fk_lpi_inspections_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
