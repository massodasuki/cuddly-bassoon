-- LpiSafetyEquipments Table Definition
CREATE TABLE `lpi_safety_equipments` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_lpi_safety_equipments_application_id` (`application_id`),
  CONSTRAINT `fk_lpi_safety_equipments_application_id` FOREIGN KEY (`application_id`) REFERENCES `applications` (`id`) ON DELETE CASCADE
