    ...
    return {
      ...
      pematuhan: {
        ...
        peralatanKeselamatan: {
          ...
          boyaKeselamatan: {
            status: peralatan.some((p: any) => p.equipment_name?.toLowerCase().includes('boya') || p.equipment_name?.toLowerCase().includes('buoy')) ? 'Ada' : 'Tiada',
            kuantiti: peralatan.find((p: any) => p.equipment_name?.toLowerCase().includes('boya') || p.equipment_name?.toLowerCase().includes('buoy'))?.amount || 'Tiada',
            keadaan: peralatan.find((p: any) => p.equipment_name?.toLowerCase().includes('boya') || p.equipment_name?.toLowerCase().includes('buoy'))?.is_active ? 'Baik' : 'Tiada',
          },
          alatPemadamApi: {
            status: peralatan.some((p: any) => p.equipment_name?.toLowerCase().includes('pemadam') || p.equipment_name?.toLowerCase().includes('fire')) ? 'Ada' : 'Tiada',
            kuantiti: peralatan.find((p: any) => p.equipment_name?.toLowerCase().includes('pemadam') || p.equipment_name?.toLowerCase().includes('fire'))?.amount || 'Tiada',
            keadaan: peralatan.find((p: any) => p.equipment_name?.toLowerCase().includes('pemadam') || p.equipment_name?.toLowerCase().includes('fire'))?.is_active ? 'Baik' : 'Tiada',
          },
          rakitKeselamatan: {
            status: peralatan.some((p: any) => p.equipment_name?.toLowerCase().includes('rakit') || p.equipment_name?.toLowerCase().includes('lifeboat')) ? 'Ada' : 'Tiada',
            kuantiti: peralatan.find((p: any) => p.equipment_name?.toLowerCase().includes('rakit') || p.equipment_name?.toLowerCase().includes('lifeboat'))?.amount || 'Tiada',
            keadaan: peralatan.find((p: any) => p.equipment_name?.toLowerCase().includes('rakit') || p.equipment_name?.toLowerCase().includes('lifeboat'))?.is_active ? 'Baik' : 'Tiada',
          },
          radioWireless: {
            status: peralatan.some((p: any) => p.equipment_name?.toLowerCase().includes('radio') || p.equipment_name?.toLowerCase().includes('wireless')) ? 'Ada' : 'Tiada',
            kuantiti: peralatan.find((p: any) => p.equipment_name?.toLowerCase().includes('radio') || p.equipment_name?.toLowerCase().includes('wireless'))?.amount || 'Tiada',
            keadaan: peralatan.find((p: any) => p.equipment_name?.toLowerCase().includes('radio') || p.equipment_name?.toLowerCase().includes('wireless'))?.is_active ? 'Baik' : 'Tiada',
          },
          gambar: {
            MTUUrl: 'https://fastly.picsum.photos/id/0/5000/3333.jpg?hmac=_j6ghY5fCfSD6tvtcV74zXivkJSPIfR9B8w34XeQmvU',
            AISUrl: 'https://fastly.picsum.photos/id/0/5000/3333.jpg?hmac=_j6ghY5fCfSD6tvtcV74zXivkJSPIfR9B8w34XeQmvU',
